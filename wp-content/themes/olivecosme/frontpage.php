    ...
    <div class="container">
      <div class="row">
        <div class="col-xs-12 col-sm-12 col-md-8 col-lg-8">
          ...
          <div class="main-l">
            <?php $args = array(
              'post_type' => array('job','event','community','mapnews'), /* 投稿タイプを指定 */
              'tax_query' => array(
                'relation' => 'OR',
                ),
              'paged' => $paged,
              ...
              <?php if (have_posts()) : ?>
               <?php while (have_posts()) : the_post(); /* ループ開始 */ ?>
                <div class="article-box pull-left">
                  <div class="article-box-detail">
                    <small><span class="label label-default">New</span><?php echo esc_html(get_post_type_object(get_post_type())->label ); ?></small>
